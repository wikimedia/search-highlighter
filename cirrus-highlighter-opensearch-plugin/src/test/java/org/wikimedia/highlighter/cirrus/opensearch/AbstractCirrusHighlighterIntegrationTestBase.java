...
import org.wikimedia.highlighter.cirrus.opensearch.plugin.CirrusHighlighterPlugin;
...
public abstract class AbstractCirrusHighlighterIntegrationTestBase extends OpenSearchIntegTestCase {
    ...
    protected Collection<Class<? extends Plugin>> nodePlugins() {
        return Collections.unmodifiableCollection(
                Arrays.asList(CirrusHighlighterPlugin.class,
                        MockPlugin.class
                ));
    }
    ...
    public static class MockPlugin extends Plugin implements AnalysisPlugin {
        ...
        public Map<String, AnalysisModule.AnalysisProvider<TokenFilterFactory>> getTokenFilters() {
            ...
            map.put("stemmer_override", requiresAnalysisSettings((isettings, env, name, settings) -> {
                List<String> rules = Analysis.parseWordList(env, settings, "rules", x -> x);
                if (rules == null) {
