 ...
 */
public class DocsAndPositionsHitEnumFromPostingsTest extends AbstractFilteredLuceneHitEnumTestBase {
    @Override
    ...
    protected HitEnum buildEnum(String source, Analyzer analyzer, CompiledAutomaton acceptable) {
        try {
            return DocsAndPositionsHitEnum.fromPostings(buildIndexReader(source, analyzer), 0, "field", acceptable);
        } catch (IOException e) {
