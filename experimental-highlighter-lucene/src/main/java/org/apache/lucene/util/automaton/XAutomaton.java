 ...
 *  {@link XAutomaton.Builder} instead.  State 0 is always the
...
public class XAutomaton {
   ...
   */
  public XAutomaton(int numStates, int numTransitions) {
  ...
  public XTransition[][] getSortedTransitions() {
    int numStates = getNumStates();
    XTransition[][] transitions = new XTransition[numStates][];
    for(int s=0;s<numStates;s++) {
      int numTransitions = getNumTransitions(s);
      transitions[s] = new XTransition[numTransitions];
  ...
  public void copy(XAutomaton other) {
   ...
   *  leaving this state. */
  public int initTransition(int state, XTransition t) {
  ...
  public void getNextTransition(XTransition t) {
  ...
  /** Fill the provided {@link XTransition} with the index'th
   *  transition leaving the specified state. */
  public void getTransition(int state, int index, XTransition t) {
  ...
  */
   ...
   *  #finish} creates the {@link XAutomaton}.  Use this
  ...
  public static class Builder {
    ...
    public void copyStates(XAutomaton other) {
      int otherNumStates = other.getNumStates();
      for (int s = 0; s < otherNumStates; s++) {
