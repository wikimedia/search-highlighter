...
public class XCompiledAutomaton {
  ...
  // Too hard to backport.  Ignoring because it isn't needed.
...
//  }
  ...
  public BytesRef floor(BytesRef input, XBytesRefBuilder output) {
  ...
  public boolean equals(Object obj) {
    ...
    XCompiledAutomaton other = (XCompiledAutomaton) obj;
