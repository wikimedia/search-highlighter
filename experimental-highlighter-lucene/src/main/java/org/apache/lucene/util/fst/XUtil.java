...
public final class XUtil {
  ...
  public static IntsRef getByOutput(FST<Long> fst, long targetOutput) throws IOException {
    ...
    final XIntsRefBuilder result = new XIntsRefBuilder();
   ...
   */
  public static IntsRef getByOutput(FST<Long> fst, long targetOutput, BytesReader in, Arc<Long> arc, Arc<Long> scratchArc, XIntsRefBuilder result) throws IOException {
  ...
  public static class FSTPath<T> {
    ...
    public T cost;
    public final XIntsRefBuilder input;

    /** Sole constructor */
    public FSTPath(T cost, FST.Arc<T> arc, XIntsRefBuilder input) {
  ...
  public static class TopNSearcher<T> {
    ...
    protected void addIfCompetitive(FSTPath<T> path) {
      ...
      XIntsRefBuilder newInput = new XIntsRefBuilder();
   ...
   *  IntsRef. */
  public static IntsRef toUTF16(CharSequence s, XIntsRefBuilder scratch) {
  ...
  public static IntsRef toUTF32(CharSequence s, XIntsRefBuilder scratch) {
    int charIdx = 0;
    int intIdx = 0;
    final int charLimit = s.length();
   ...
   *  IntsRef, which must not be null, returning it. */
  public static IntsRef toUTF32(char[] s, int offset, int length, XIntsRefBuilder scratch) {
    int charIdx = offset;
    int intIdx = 0;
  ...
  public static IntsRef toIntsRef(BytesRef input, XIntsRefBuilder scratch) {
    scratch.clear();
    for(int i=0;i<input.length;i++) {
